...
// 6 Noticias Oficiales Reales verificadas en La Razón sobre Correos de Bolivia
export const NOTICIAS_LA_RAZON_OFICIALES: NoticiaScrapeada[] = [
  ...
  },
  {
    ...
    palabrasClave: ["agbc", "centro de tratamiento postal", "correos de bolivia"],
  },
  {
    ...
    palabrasClave: ["correos", "mi encomienda", "agencia boliviana de correos"],
  },
  {
    ...
    palabrasClave: ["agbc", "sellos postales", "filatelia"],
  },
  {
    ...
    palabrasClave: ["correos de bolivia", "agencia boliviana de correos", "cartas"],
  },
]
